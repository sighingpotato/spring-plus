...
| 1일차                                                                                                                                                                                                          | 2일차                                    |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| 1. 코드 개선 퀴즈 - @Transactional의 이해<br />2. 코드 추가 퀴즈 - JWT의 이해<br />3. 코드 개선 퀴즈 - JPA의 이해<br />4. 테스트 코드 퀴즈 - 컨트롤러 테스트의 이해<br />5. 코드 개선 퀴즈 - AOP의 이해<br />6. JPA Cascade<br />7. N+1<br />8. QueryDSL<br />9. Spring Security | 10. QueryDSL을 사용하여 검색 기능 만들기<br />11. Transaction 심화 |
